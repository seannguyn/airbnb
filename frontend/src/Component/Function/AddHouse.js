...
class AddHouse extends React.Component {
  ...
  async onSubmit(dispatch, e) {
    ...
    const {bed, address, latitude, longitude, bedroom, bathroom, kitchen, gym, pool, carpark} = this.state;
                ...
                <form className={classes.form} onSubmit={this.onSubmit.bind(this, dispatch)}>
                  ...
                  <FormControl className={classes.formControl} error={this.state.error_Accommodation_Type}>
                    ...
                    <Select
                      ...
                      onChange={this.onChange.bind(this)}
                      inputProps={{name: 'Accommodation_Type', id: 'accom-type'}}>
