        ...
        <div>
          <AppBar position="static" color="default">
            ...
            >
              ...
              <Tab label={<span style={{ color: '#3f51b5', fontWeight: '900'}}>Payment</span>} icon={<CheckIcon style={{ color: '#3f51b5',fontWeight: '900' }}/>}/>
              <Tab label={<span style={{ color: '#3f51b5', fontWeight: '900'}}>Confirmation</span>} />
            </Tabs>
          </AppBar>
            ...
            >
                  ...
                  <TabContainer dir={theme.direction}>
                    ...
                    <div className="row" style={{marginTop:'20px'}}>
                      <Button variant="contained" color="primary" onClick={this.handleChange.bind(this, 1)}>Cool</Button>
                    </div>
                  ...
                  <TabContainer dir={theme.direction}>
                    ...
                    <div className="container" style={{border: '3px solid red'}}>
                      ...
                      <Button onClick={this.handleChange.bind(this, 2)}>Next</Button>
                      <Button onClick={this.handleChange.bind(this, 0)}>Backward</Button>
