        ...
        <Consumer>
          {value => {
            ...
            repliedRequest.map((r) => {
              repliedRequestComponent.push(<RepliedRequest key={r.id} request={r}/>)
              return 1;
            })
              ...
              <div className="container">
                ...
                <div className="row" style={{ margin:'10px'}}>
                  <Badge className={classes.margin} badgeContent={<Typography style={{ color: '#FFFFFF',fontSize: '12.5px' }}>{newRequest.length}</Typography>} color="primary">
                    <Typography variant="display3" color="textSecondary">New Requests</Typography>
                  </Badge>
                </div>
                ...
                <div className="row" style={{ margin:'10px'}}>
                  <Typography variant="display3" color="textSecondary">Replied Requests</Typography>
                </div>
