        ...
        <div>
          <AppBar position="static" color="default">
            <Tabs
              ...
              fullWidth
            >
              <Tab label={<span style={{color: '#3f51b5', fontWeight: '900'}}>Review Detail</span>}
                   icon={<CheckIcon style={{color: '#3f51b5', fontWeight: '900'}}/>}/>
                  ...
                  <TabContainer dir={theme.direction}>
                    ...
                    <div className="row" style={{marginTop: '20px'}}>
                      <Button variant="contained" color="primary"
                              onClick={this.handleChange.bind(this, 1)}>Cool</Button>
                    </div>
